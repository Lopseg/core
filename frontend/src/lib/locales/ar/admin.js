...
export default {
  settings: {
    ...
    configSets: {
      ...
      migrationRequiresSystemAdmin: 'يتطلب التحويل إلى مجموعة التكوين هذه ترحيل بيانات يمكن فقط لمدير النظام تنفيذه.',
    ...
    sso: {
      ...
      unsafeProvisioningWarningBody:
        'يتم ربط هويات هذا الموفر بحسابات موجودة عبر البريد الإلكتروني حتى عندما يصرح الموفر بأن العنوان غير محقق. فعّل هذا فقط إذا كان الموفر يتحكم بعناوين بريد مستخدميه.',
