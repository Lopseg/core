...
export default {
  actions: {
    ...
    config: {
      ...
      scopeThisItem: 'This item',
      scopeParentItem: 'Parent item',
      operator: 'Operator',
    ...
    placeholders: {
      ...
      trigger: {
        ...
        fieldFallback: 'Shorthand for the new value, e.g. trigger.iteration_id',
        oldField: 'Previous value of a changed field, e.g. trigger.old_iteration_id',
      },
      parent: {
        openChildCount: 'Open direct children of the parent item',
        any: 'Any field of the parent item',
      },
    },
